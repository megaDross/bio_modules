...
def check_input_errors(primer_name, f_primer, r_primer, hg_version):
    ...
    if hg_version not in ['hg38', 'hg19', 'hg18', 'hg17', 'hg16']:    
        raise ex.WrongHG(hg_version)   
        ...
        with open(args['input'], 'r') as in_file:
            for line in in_file:
                try:
                    ...
                    out.write(print_metadata+"\n")

                except (ex.MultipleAmplicons, ex.NoAmplicon, ex.WrongHG, ex.AmbigousBase) as e:
                    logging.error(e.msg)
                    continue
